...
> **規範依據**  
> 本流程之各項審查門檻、SOP 改寫、Word 排版與目錄管理標準，嚴格依據 [`rules/`](../../rules/README.md) 體系執行：
> * 目錄管理準則 👉 [`rules/00_規則體系總綱與目錄管理規範.md`](../../rules/00_規則體系總綱與目錄管理規範.md)
> * 選題審查紅線 👉 [`rules/01_新聞選題與審查紅線規範.md`](../../rules/01_新聞選題與審查紅線規範.md)
> * 改寫 11 步 SOP 👉 [`rules/02_新聞改寫與11步SOP規範.md`](../../rules/02_新聞改寫與11步SOP規範.md)
