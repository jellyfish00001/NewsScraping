...
| `YYYYMMDD/` (如 [`20260906/`](./20260906/)) | **每日新聞產出目錄**：<br>• 外層：存放兩張約 516*292 等比例新聞配圖。<br>• `AI文字內容/`：每日兩篇符合 11 步 SOP 之新聞文字稿件。<br>• `DOC範本/`：後續待填入 Word 範本與輸出成檔預留區。 |
...
2. **新增/異動範本檔案**：若在 `templates/` 中調整發稿結構或 Prompt，需同步更新本檔「SOP 流程」與「模板索引」。
